  ...
  return (
    <>
      ...
      <div className="p-2">
        ...
        {/* Selettore vista */}
        <div className="flex gap-1 mb-3 bg-gray-100 rounded-xl p-1 no-print">
        ...
        {viewMode === 'week' && (
          <div className="flex gap-2 mb-3 no-print">
            ...
            <button onClick={handlePrint}
              className="flex items-center gap-1 px-3 py-2 rounded-xl bg-gray-100 text-gray-600 text-sm font-medium">
        ...
        {showModal && selectedCell && (
          <div className="fixed inset-0 bg-black/50 flex items-end z-50 no-print">
